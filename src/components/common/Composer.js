...
import { verify, sign, decrypt, encrypt } from '../../helpers/pgp'
...
class Composer extends Component {
  ...
  //   if (!this.props.isShowingComposer && nextProps.isShowingComposer) {
  ...
  // handleEncrypt = _action(encrypt, this.props.publicKeys)
